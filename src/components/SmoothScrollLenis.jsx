...
const Nav = () => {
  return (
    <nav className="fixed left-0 right-0 top-0 z-50 flex items-center justify-between px-4 sm:px-6 py-3 text-[#f1f1f1]">
      <h1 className="text-2xl sm:text-4xl">Logo</h1>
      <h2 className="text-sm sm:text-base">Χειμερινές Καλλιέργειες</h2>
    </nav>
  );
};
