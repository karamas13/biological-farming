...
import corn from "/photos/corn.avif";
...
const CenterImage = () => {
  ...
  return (
    <motion.div className="sticky top-0 left-0 w-full h-screen overflow-hidden bg-zinc-950" style={{ opacity, clipPath }}>
      <motion.img
        src={kolokythi6}
        alt="Κεντρική εικόνα καλοκαιρινής παραγωγής - Κολοκύθια στο αγρόκτημα"
        fetchpriority="high" 
...
const ParallaxImages = () => {
  return (
    <div className="mx-auto max-w-7xl px-4 pt-[200px] sm:pt-[150px]">
      <ParallaxImg src={kalampoki5} alt="Φρέσκο καλαμπόκι στο χωράφι" start={-200} end={200} className="w-full sm:w-1/3 h-[20em] object-cover" />
      <ParallaxImg src={kolokythi2} alt="Συγκομιδή κολοκυθιών" start={200} end={-250} className="mx-auto w-full sm:w-2/3 h-[35em] object-cover" />
      <ParallaxImg src={goggulokramvh5} alt="Λεπτομέρεια γογγυλοκράμβης" start={-200} end={200} className="w-full sm:w-1/3 ml-auto h-[20em] object-cover" />
      <ParallaxImg src={kolokythi5} alt="Καλοκαιρινά λαχανικά παραγωγής μας" start={-200} end={-200} className=" w-full sm:w-5/12 h-[20em] object-cover" />
    </div>
  );
};
